...
def main(w: int, h: int, nframe: int, expos: float, gain: int, decim: int,
         color: bool, tenbit: bool, preview: bool, verbose: bool=False) -> Tuple[np.ndarray, float, Dict[str, int]]:
    # %% setup camera class
...
if __name__ == '__main__':
    ...
    p.add_argument('-c', '--color', help='use Bayer demosaic for color (display only, disk writing is raw)',
                   action='store_true')
